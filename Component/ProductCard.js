...
const ProductCard = ({ props }) => {
    ...
    return (
        <div className="text-gray-600 body-font flex justify-center items-center m-5">
                ...
                <div className="flex flex-wrap m-4">
                    ...
                    <div className="w-60 h-60 p-2">
                        <div className="px-7 py-3 border-4 border-gray-200 rounded-xl bg-white ">
                            <h1 className="tracking-widest text-2xl title-font font-bold  text-[#ec3503] mb-2">{props.slug}</h1>
                            <div className='flex justify-center items-center mt-4 gap-3'>
                                <div>
                                    <h2 className="title-font text-2xl font-medium text-gray-900 m-2">Price: ₹{props.price}</h2>
                                    <p className="leading-relaxed text-2xl">Quantity:{props.quantity}</p>
                                </div>
                                <div>
